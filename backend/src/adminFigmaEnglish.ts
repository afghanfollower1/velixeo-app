...
/* VELIXEO DESIGN 2026-09-23 — exact visual tokens from velixeo-design.zip */
:root{--blue:#38bdf8;--cyan:#7dd3fc;--nav:#fff;--nav2:#fff;--bg:#f7f9fc;--card:#fff;--text:#24343d;--muted:#74818b;--line:#e7eef2;--green:#158365;--red:#c54152;--amber:#ad670d;--purple:#9580ca;--shadow:none}
html,body{font-family:Inter,Arial,sans-serif;background:var(--bg);color:var(--text)}
html[dir=rtl] body,html[lang=fa] body{font-family:Vazirmatn,Arial,sans-serif}
.layout{grid-template-columns:244px minmax(0,1fr);background:#f7f9fc}
.side{background:#fff;color:#8795a1;border-inline-end:1px solid #edf1f5;padding:32px 22px;box-shadow:none}
.brand{border-bottom:0;margin-bottom:20px;padding:0 2px 10px;color:#24343d}
.brand b{font-size:19px;color:#24343d}.brand small{color:#97a8b1;font-size:10px}
.vlogo{filter:none}.cap{font-size:10px;color:#b0bac2;padding:15px 12px 7px;letter-spacing:.3px}
.nav{color:#8795a1;padding:12px 13px;border-radius:12px;margin:3px 0;font-size:13px}
.nav:hover{background:#f7fbfd;color:#318eb6}.nav.active{background:#eef9fe;color:#318eb6;box-shadow:none;font-weight:650}
.nav.active .ico{stroke-width:2}.subnav{padding-inline-start:0;border-inline-start:0;margin-inline-start:0}.subnav .nav{font-size:12px;padding:11px 13px}
.logout{border:1px solid #f1dfe2;color:#c54152;border-radius:12px;padding:11px;background:#fff}
.main{padding:30px 38px}.topbar{height:64px;background:#f7f9fc;backdrop-filter:none}
.search{height:40px;border-radius:14px;border-color:#e7eef2;box-shadow:none}.notif{border-radius:14px}
.avatar{border-radius:15px;background:#e2f3fe;color:#438aa8}.admin b{font-size:12px}.admin small{font-size:10px}
.head{margin:7px 0 24px}.head h1{font-size:24px;font-weight:720}.head p{font-size:12px}.crumb{font-size:11px}
.stat,.card{border:1px solid #eef2f5;border-radius:20px;box-shadow:none}.stat{padding:20px}.card{padding:21px;margin-bottom:18px}
.sicon{border-radius:13px;background:#eef9fe;color:#58b3d6}.stat small{font-size:12px}.stat strong{font-size:25px;font-weight:700}
.cardhead h2,.cardhead h3{font-size:15px}.muted{font-size:11px;color:#74818b}.link{font-size:11px;color:#318eb6}
.grid{gap:22px}.grid.eq{gap:18px}.stats{gap:14px;margin-bottom:22px}
.table th,.table td{padding:14px 10px;font-size:11px}.table th{background:#f8fafc;color:#8898a5;font-weight:500}
.pill{border-radius:8px;font-size:10px;padding:3px 9px}.pill.info{background:#eaf7fe;color:#287495}.pill.ok{background:#eaf8f1;color:#158365}.pill.warn{background:#fff5e7;color:#ad670d}.pill.bad{background:#fceef0;color:#c54152}
.tabs{gap:5px;border-bottom:1px solid #e7eef2;margin:0 0 24px}.tab{border:0;border-bottom:2px solid transparent;border-radius:0;background:transparent;color:#80919d;padding:12px 14px;font-size:12px}.tab.active{background:transparent;color:#2288b1;border-bottom-color:#38bdf8}
.field label{font-size:11px;color:#74818b}.field input,.field select,.field textarea{border-radius:12px;border-color:#dfe8ed;padding:11px 14px;font-size:12px}.field input,.field select{height:44px}
.btn{min-height:40px;border-radius:13px;background:#38bdf8;color:#183b4b;font-size:11px;font-weight:650;box-shadow:0 4px 12px #38bdf821}.btn.ghost{background:#fff;border:1px solid #e7eef2;color:#347996}.btn.danger{background:#fff0f1;border-color:#f5dadd;color:#c54152}
.notice{border-radius:14px;background:#eef9fe;color:#40748b;border:0;padding:14px 16px;font-size:11px}
.modulehero,.nhero{background:#edf7fc;color:#245168;border:1px solid #dceef8}.modulehero p,.nhero p{color:#74818b}
.footer{color:#a1b1bc;font-size:9px}
html[dir=rtl] .layout,html[lang=fa] .layout{direction:rtl}
html[dir=rtl] .side,html[lang=fa] .side,html[dir=rtl] .main,html[lang=fa] .main{direction:rtl}
html[dir=rtl] .table th,html[dir=rtl] .table td,html[lang=fa] .table th,html[lang=fa] .table td{text-align:right}
@media(max-width:1080px){.layout{grid-template-columns:205px minmax(0,1fr)}.main{padding:25px 24px}}
