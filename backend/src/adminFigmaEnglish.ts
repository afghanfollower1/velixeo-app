...
.admin-shell{display:grid;grid-template-columns:minmax(0,1fr) 244px;direction:rtl;min-height:100vh;background:#f7f9fc}
.admin-shell.ltr{grid-template-columns:244px minmax(0,1fr);direction:ltr}
.admin-sidebar{grid-column:2;background:#fff;border-inline-start:1px solid #edf1f5;padding:32px 22px;position:sticky;top:0;height:100vh;overflow:auto;display:flex;flex-direction:column;z-index:20}
.admin-shell.ltr .admin-sidebar{grid-column:1;border-inline-start:0;border-inline-end:1px solid #edf1f5}
...
.admin-main{grid-column:1;min-width:0;padding:30px 38px;direction:rtl}
.admin-shell.ltr .admin-main{grid-column:2;direction:ltr}
.admin-top{display:flex;align-items:center;justify-content:space-between;gap:20px;margin-bottom:30px;position:relative;background:transparent;height:auto;top:auto}
...
.admin-top .search{width:265px;max-width:265px;height:auto;font-size:12px;display:flex;align-items:center;position:relative;background:#fff;border:1px solid var(--line);border-radius:14px;gap:10px;padding:0 14px}
...
html.vx-admin-fa .admin-main{text-align:right}html.vx-admin-en .admin-main{text-align:left}
...
html.vx-admin-fa input,html.vx-admin-fa select,html.vx-admin-fa textarea{text-align:right;font-family:Vazirmatn,Arial,sans-serif}
html.vx-admin-en input,html.vx-admin-en select,html.vx-admin-en textarea{text-align:left;font-family:Inter,Arial,sans-serif}
...
@media(max-width:1180px){.admin-shell{grid-template-columns:minmax(0,1fr) 205px}.admin-shell.ltr{grid-template-columns:205px minmax(0,1fr)}.admin-sidebar{padding:28px 14px}.admin-main{padding:25px 24px}.stats,.dashboard-kpis{gap:12px}.stat{padding:18px}.stat strong{font-size:24px}.admin-top .search{width:200px}.grid{grid-template-columns:1fr 1fr}}
@media(max-width:900px){.admin-shell,.admin-shell.ltr{grid-template-columns:1fr;display:block}.admin-sidebar{position:fixed;top:0;height:100vh;width:240px;z-index:99998;transition:transform .2s;box-shadow:-20px 0 40px #193e4b11}.admin-main{padding:66px 22px 22px}.admin-top .search{display:none}.grid{grid-template-columns:1fr 1fr}}
