...
const translations: Record<string, string> = {
  ...
  'Brands are customer-facing networks such as Instagram, TikTok, Telegram and WhatsApp. Names, icons, order and visibility are server-driven.': 'برندها همان شبکه‌هایی هستند که مشتری می‌بیند؛ مانند اینستاگرام، تیک‌تاک، تلگرام و واتساپ. نام، آیکن، ترتیب و نمایش از سرور مدیریت می‌شود.',
  'Examples: Instagram → Followers, Likes, Views · TikTok → Followers, Views. Create Brands first, then attach categories. Changes are server-driven.': 'نمونه: اینستاگرام ← فالوور، لایک، بازدید · تیک‌تاک ← فالوور، بازدید. ابتدا برندها را بسازید و سپس دسته‌بندی‌ها را به آن‌ها متصل کنید. تغییرات از سرور مدیریت می‌شوند.',
  'Paste the provider API key here': 'کلید API ارائه‌دهنده را اینجا وارد کنید',
  'Internal notes about this provider': 'یادداشت داخلی درباره این ارائه‌دهنده',
  'Slug (optional)': 'شناسه لاتین (اختیاری)',
  'Leave blank and VELIXEO creates a unique slug automatically.': 'اگر خالی بگذارید، VELIXEO یک شناسه یکتا به‌صورت خودکار می‌سازد.',
  'All provider prices are converted to AFN. Add extra currencies and AFN rates in Settings → Exchange Rates.': 'تمام قیمت‌های ارائه‌دهنده به افغانی تبدیل می‌شوند. ارزها و نرخ‌های اضافی را از تنظیمات ← نرخ ارز اضافه کنید.',
  'Lower number is preferred first.': 'عدد کمتر، اولویت بالاتری دارد.',
  'Timeout (seconds)': 'مهلت اتصال (ثانیه)',
  'Auto Service Sync': 'همگام‌سازی خودکار سرویس‌ها',
  'Service Sync Interval (minutes)': 'فاصله همگام‌سازی سرویس‌ها (دقیقه)',
  'Close': 'بستن',
  'Original provider name:': 'نام اصلی ارائه‌دهنده:',
  'Provider cost:': 'هزینه ارائه‌دهنده:',
  'Choose category': 'انتخاب دسته‌بندی',
  'Stable key used by categories and services.': 'شناسه ثابت مورد استفاده دسته‌بندی‌ها و سرویس‌ها.',
  'VELIXEO default icon library': 'کتابخانه آیکن پیش‌فرض VELIXEO',
  'Upload PNG / JPG / WebP': 'آپلود PNG / JPG / WebP',
  'Square icon recommended. Maximum about 400 KB.': 'آیکن مربع پیشنهاد می‌شود. حداکثر حجم حدود ۴۰۰ کیلوبایت.',
  'An uploaded icon is already saved. Choose a file only to replace it.': 'یک آیکن آپلودشده ذخیره است. فقط برای جایگزینی فایل جدید انتخاب کنید.',
  'Brand → Category → Service': 'برند ← دسته‌بندی ← سرویس',
  'Brand → Category → Services': 'برند ← دسته‌بندی ← سرویس‌ها',
  'Sort': 'ترتیب',
  'No brands yet.': 'هنوز برندی ثبت نشده است.',
  'Manage names and icons from Brands.': 'نام‌ها و آیکن‌ها را از بخش برندها مدیریت کنید.',
  'Customer Order ID': 'شناسه سفارش مشتری',
  'Choose what customers see as their Order ID.': 'مشخص کنید مشتری چه شناسه‌ای را به‌عنوان شماره سفارش ببیند.',
  'Example: 100063. Existing assigned numbers are never changed.': 'نمونه: ۱۰۰۰۶۳. شماره‌های قبلی هرگز تغییر نمی‌کنند.',
  'English Terms & Conditions': 'شرایط و قوانین انگلیسی',
  'Persian Terms & Conditions': 'شرایط و قوانین فارسی',
  'Save Order Settings': 'ذخیره تنظیمات سفارش',
  'How it works': 'نحوه کار',
  'Server enforced': 'اعمال‌شده در سرور',
  'Provider/API ID:': 'شناسه ارائه‌دهنده / API:',
  'VELIXEO Sequential ID:': 'شناسه ترتیبی VELIXEO:',
  'Refill:': 'جبران:',
  'Cancel:': 'لغو:',
  ...
  'Hide brand from app': 'پنهان کردن برند از اپ',
  'Show brand in app': 'نمایش برند در اپ',
  'Hide category from app': 'پنهان کردن دسته‌بندی از اپ',
  'Show category in app': 'نمایش دسته‌بندی در اپ',
  'Icon is too large. Keep it below about 400 KB.': 'حجم آیکن زیاد است. آن را کمتر از حدود ۴۰۰ کیلوبایت نگه دارید.',
  ...
  'Draft': 'پیش‌نویس',
  'No route': 'بدون مسیر',
  'No refill': 'بدون جبران',
  'Yes': 'بله',
  'No': 'خیر',
  'API Endpoint': 'آدرس API',
  'API Key': 'کلید API',
  'Default Markup %': 'درصد سود پیش‌فرض',
