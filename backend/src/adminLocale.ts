...
const translations: Record<string, string> = {
  ...
  'Brands': 'برندها',
  'Social Brands': 'برندهای شبکه اجتماعی',
  ...
  'Order ID Mode': 'حالت شناسه سفارش',
  'Provider/API Order ID': 'شناسه سفارش Provider/API',
  'VELIXEO Sequential Order ID': 'شناسه ترتیبی VELIXEO',
  'Sequential Start Number': 'شماره شروع شناسه ترتیبی',
  'Refill Window After Completion (hours)': 'مهلت جبران پس از تکمیل (ساعت)',
  'English Terms & Conditions': 'قوانین و مقررات انگلیسی',
  'Persian Terms & Conditions': 'قوانین و مقررات فارسی',
