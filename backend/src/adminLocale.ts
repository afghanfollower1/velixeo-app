...
const translations: Record<string, string> = {
  ...
  'Telegram admin invoice alerts': 'اعلان فاکتور تلگرام برای مدیر',
  'Sent only after wallet payment succeeds.': 'فقط پس از موفقیت پرداخت از کیف پول ارسال می‌شود.',
  ...
  'Send paid Premium order alerts': 'ارسال اعلان سفارش‌های پریمیوم پرداخت‌شده',
  'Save alert settings': 'ذخیره تنظیمات اعلان',
  'Send test message': 'ارسال پیام آزمایشی',
  'Alert logic': 'منطق اعلان',
  'Paid orders only': 'فقط سفارش‌های پرداخت‌شده',
  'Bot token': 'توکن ربات',
