...
function localeInjection() {
  ...
  html[dir=rtl] .vx-locale{right:auto;left:18px}html[dir=rtl] body{direction:rtl;font-family:"Vazirmatn","IRANYekan","IRANSans",Tahoma,Arial,sans-serif;letter-spacing:0}html[dir=rtl] .layout{grid-template-columns:minmax(0,1fr) 252px}html[dir=rtl] .side{grid-column:2;grid-row:1;text-align:right;padding:20px 15px}html[dir=rtl] .main{grid-column:1;grid-row:1;padding:0 22px 20px}html[dir=rtl] .brand,html[dir=rtl] .nav,html[dir=rtl] .back,html[dir=rtl] .provider-name,html[dir=rtl] .split-title{flex-direction:row-reverse}html[dir=rtl] .nav,html[dir=rtl] .back{justify-content:flex-start;text-align:right}html[dir=rtl] .topbar{grid-template-columns:auto minmax(260px,1fr)}html[dir=rtl] .topbar .search{grid-column:2;grid-row:1}html[dir=rtl] .topbar .admin{grid-column:1;grid-row:1}html[dir=rtl] .head,html[dir=rtl] .top,html[dir=rtl] .cardhead{direction:rtl}html[dir=rtl] .head h1,html[dir=rtl] .top h1{font-size:23px;font-weight:900;line-height:1.5}html[dir=rtl] .head p,html[dir=rtl] .top p,html[dir=rtl] .muted{line-height:1.8}html[dir=rtl] .table th,html[dir=rtl] .table td,html[dir=rtl] table th,html[dir=rtl] table td{text-align:right;line-height:1.7}html[dir=rtl] input,html[dir=rtl] select,html[dir=rtl] textarea{text-align:right;font-family:inherit}html[dir=rtl] .mono{direction:ltr;text-align:left;font-family:ui-monospace,SFMono-Regular,Consolas,monospace}html[dir=rtl] .actions{justify-content:flex-start}html[dir=rtl] .forms,html[dir=rtl] .tabs{direction:rtl}html[dir=rtl] .card{border-radius:16px;box-shadow:0 7px 26px rgba(27,72,113,.05)}html[dir=rtl] .btn{font-weight:800;min-height:38px}html[dir=rtl] .tab{font-size:11px;padding:9px 12px}html[dir=rtl] .subnav{padding-left:0;padding-right:18px;border-left:0;border-right:1px solid rgba(255,255,255,.09);margin-left:0;margin-right:18px}
